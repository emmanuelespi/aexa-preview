            ...
            <form>
                ...
                <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        <label class="text-sm font-medium leading-6 text-gray-900" for="">Logotipo</label>
                        <input
                            class="block w-full rounded-md bg-gray-50 cursor-pointer border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:outline-none sm:text-sm sm:leading-6"
                            type="file" id="logo" name="logo">
                    </div>
                </div>
                <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        <label for="" class="text-sm font-medium leading-6 text-gray-900">Regimen
                            fiscal:</label>
                        <div class="mt-2">
